...
const auth_module_1 = require("./common/guards/auth.module");
const prisma_module_1 = require("./config/prisma.module");
const encryption_module_1 = require("./common/encryption/encryption.module");
const meta_auth_module_1 = require("./modules/meta-auth/meta-auth.module");
...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            meta_auth_module_1.MetaAuthModule,
